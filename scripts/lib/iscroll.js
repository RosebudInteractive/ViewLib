...
// INSERT POINT: _wheel
    ...
    function createDefaultScrollbar (direction, interactive, options) {
        ...
        if ( direction == 'h' ) {
            if ( type === true ) {
                scrollbar.style.cssText += ';height:0.25em;left:2px;right:2px;bottom:' + bottomPadding + 'px';
            ...
            if ( type === true ) {
                ...
                scrollbar.style.cssText += ';width:0.25em;bottom:'+bottomPadding+'px;top:'+topPadding+'px;right:'+rightPadding+'px';
